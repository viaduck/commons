...
TEST_F(LogTest, EnableDisable) {
    ...
    Log::dbg<<"Test 123";
    Log::err<<"1337 456";
    EXPECT_EQ("[LogLevel::DEBUG] Test 123", mLogger->toString(LogLevel::DEBUG));
    EXPECT_EQ("[LogLevel::ERROR] 1337 456", mLogger->toString(LogLevel::ERROR));
    mLogger->clear();
    ...
    Log::dbg<<"Test 123";
    Log::err<<"1337 456";
    EXPECT_NE("[LogLevel::DEBUG] Test 123", mLogger->toString(LogLevel::DEBUG));
    EXPECT_NE("[LogLevel::ERROR] 1337 456", mLogger->toString(LogLevel::ERROR));
