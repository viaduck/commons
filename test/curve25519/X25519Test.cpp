 ...
 * Copyright (c) 2016, The ViaDuck Project
 *
...
#include "X25519Test.h"


TEST_F(X25519Test, testBasic) {
    ...
    uint8_t out[32];
    own_X25519(out, kScalar1, kPoint1);
    ...
    ASSERT_EQ(0, memcmp(kExpected1, out, sizeof(out)));
    ...
    own_X25519(out, kScalar2, kPoint2);
    ...
    ASSERT_EQ(0, memcmp(kExpected2, out, sizeof(out)));
}

TEST_F(X25519Test, testSmallOrder) {
    ...
    ASSERT_EQ(0, own_X25519(out, private_key, kSmallOrderPoint));
}

TEST_F(X25519Test, testIterated) {
    /* Taken from https://tools.ietf.org/html/rfc7748#section-5.2 */
    uint8_t scalar[32] = {9}, point[32] = {9}, out[32];

    unsigned i;
    for (i = 0; i < 1000; i++) {
        own_X25519(out, scalar, point);
    ...
    ASSERT_EQ(0, memcmp(kExpected, scalar, sizeof(kExpected)));
}
